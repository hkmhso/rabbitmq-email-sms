...
@Component
public class ProducerMatchOneTopic{
    @Autowired
    ...
    public static final String MATCH_ONE_ROUTING_KEY = "topic_routing_key.matchone";
    ...
    public void sendForNotScheduledForConfirm(String exchangeName) {
        String msg = "发送给消费者的路由键为" + ProducerMatchOneTopic.MATCH_ONE_ROUTING_KEY;
        ...
        rabbitTemplate.convertAndSend(exchangeName,ProducerMatchOneTopic.MATCH_ONE_ROUTING_KEY,message,correlationData);
    }
