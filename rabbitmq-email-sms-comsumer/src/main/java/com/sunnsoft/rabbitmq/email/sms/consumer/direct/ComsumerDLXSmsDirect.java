...
import com.sunnsoft.rabbitmq.email.sms.common.utils.PrintUtils;
import com.sunnsoft.rabbitmq.email.sms.common.utils.SmsUtils;
import com.sunnsoft.rabbitmq.email.sms.config.direct.DirectDLXRabbitConfig;
...
@Component
@Slf4j
public class ComsumerDLXSmsDirect {
     ...
     */
    @RabbitHandler
    @RabbitListener(queues = DirectDLXRabbitConfig.DIRECT_SMS_DLX_QUEUE_NAME,containerFactory = "rabbitListenerContainerFactory")
