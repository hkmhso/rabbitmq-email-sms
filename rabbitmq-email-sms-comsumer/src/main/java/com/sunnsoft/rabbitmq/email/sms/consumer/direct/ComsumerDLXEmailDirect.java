...
@Component
@Slf4j
public class ComsumerDLXEmailDirect {
     ...
     */
    @RabbitHandler
    @RabbitListener(queues = DirectDLXRabbitConfig.DIRECT_EMAIL_DLX_QUEUE_NAME,containerFactory = "rabbitListenerContainerFactory")
