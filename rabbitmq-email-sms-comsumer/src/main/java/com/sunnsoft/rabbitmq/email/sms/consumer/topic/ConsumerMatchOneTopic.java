...
@Component
@Slf4j
public class ConsumerMatchOneTopic {
     ...
     */
    @RabbitHandler
    @RabbitListener(queues = TopicRabbitConfig.MATCH_ONE_QUEUE_NAME,containerFactory = "rabbitListenerContainerFactory")
